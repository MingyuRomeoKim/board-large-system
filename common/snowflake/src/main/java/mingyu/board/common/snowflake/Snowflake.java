package mingyu.board.common.snowflake;

import java.util.random.RandomGenerator;

public class Snowflake {
	private static final int UNUSED_BITS = 1;
	private static final int EPOCH_BITS = 41; // timestemp 순차성 보장
	private static final int NODE_ID_BITS = 10; // nodeId로 유니트 1차 보장
	private static final int SEQUENCE_BITS = 12; // sequence로 유니트 2차 보장
